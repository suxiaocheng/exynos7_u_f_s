...
ifndef LDSCRIPT
	...
	ifeq ($(wildcard $(LDSCRIPT)),)
ifdef CONFIG_ARM64
		LDSCRIPT := $(TOPDIR)/arch/$(ARCH)/cpu/armv8/u-boot.lds
else
...
ifeq ($(CONFIG_EXYNOS_LCD_ON_UBOOT), y)
LIBS += drivers/video/exynos/libdecon.o
endif
...
ifeq ($(CONFIG_ARM64),)
ifneq ($(CONFIG_CPU_EXYNOS5430)$(CONFIG_CPU_EXYNOS5412)$(CONFIG_CPU_EXYNOS5260)$(CONFIG_CPU_EXYNOS4415)$(CONFIG_CPU_EXYNOS3250)$(CONFIG_CPU_EXYNOS3472),)
...
else ifneq ($(CONFIG_CPU_EXYNOS5412)$(CONFIG_CPU_EXYNOS5260)$(CONFIG_CPU_EXYNOS4415)$(CONFIG_CPU_EXYNOS3250)$(CONFIG_CPU_EXYNOS3472),)
