 ...
 *
 * Configuration settings for the SAMSUNG ESPRESSO7420 (EXYNOS7420) board.
 *
...
#define CONFIG_MACH_ESPRESSO7420	/* which is in a ESPRESSO7420 */

/* This defined because the touch and the OLED power must use same i2c line */
/*#define CONFIG_SKH_REV10*/

/* for serial2usb chip power of M400*/
/*#define CONFIG_M400*/

/* for linux ubuntu */
#define CONFIG_LINUX_KERNEL_FASTBOOT

#define CONFIG_MACH_EXSOM7420SB 1
/* CONFIG_PREVENT_HALTING_UFS_FAIL_AT_ENV_READ_WRITE 는 env 읽기 fail 로 ramdisk 못읽는 error 발생  */
/*#define CONFIG_PREVENT_HALTING_UFS_FAIL_AT_ENV_READ_WRITE	1 */
/* 임시로 UFS boot을 위해서 사용 */
/*#define CONFIG_UFS_LOW_SPEED */
#define CONFIG_UFS_ADD_WAITING_DELAY
#define CONFIG_CMD_IORW

/*#define CONFIG_DEBUG_MMC_SD */
#define CONFIG_PMIC_ACT8892_TEST
#define CONFIG_PMIC_ACT8892_OLED_FHD

#ifdef CONFIG_MACH_EXSOM7420SB
#define CONFIG_EMMC_UFS_POWER_ON 1
/*#define CONFIG_MMC_TRACE*/
#endif

#define CONFIG_BOARD_NAME		"EXSOM7420_AARCH64"
...
/* input clock of PLL: ESPRESSO7420 has 24MHz input clock */
...
#define CONFIG_MACH_TYPE		MACH_TYPE_EXSOM7420
...
/*#define CONFIG_EXTRA_ENV_SETTINGS       "rootfslen= 0xF1015"*/  /* bskim*/
#define CONFIG_EXTRA_ENV_SETTINGS       "rootfslen= 0xA00000"
#endif
