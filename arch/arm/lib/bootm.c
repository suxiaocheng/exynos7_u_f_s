...
#if defined(CONFIG_CPU_EXYNOS5430) || defined(CONFIG_CPU_EXYNOS4415)
...
static void setup_memory_tags(bd_t *bd)
{
	...
	if (*(unsigned int *)(CONFIG_SYS_SDRAM_BASE + 4) == 0xC0000000)
		nr_dram_banks = 12;
	else
		nr_dram_banks = 8;
#else
...
#ifdef CONFIG_ARM64
	kernel_entry((unsigned long)images->dtb_start, machid, r2);
#else
