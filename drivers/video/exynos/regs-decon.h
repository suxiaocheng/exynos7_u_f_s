...
#define ENHANCER_MIC_CTRL_MDNIE_ON_F		(1 << 13)
#define ENHANCER_MIC_CTRL_MDNIE_PCLK_GATE	(1 << 11)
...
#define MDNIE_FRM_BLANK				0x2800
#define MDNIE_FRM_BLANK_FRONT_F(_v)		((_v) << 20)
#define MDNIE_FRM_BLANK_SYNC_F(_v)		((_v) << 10)
#define MDNIE_FRM_BLANK_BACK_F(_v)		((_v) << 0)

#define MDNIE_LINE_BLANK			0x2804
#define MDNIE_LINE_BLANK_F(_v)			((_v) << 0)
