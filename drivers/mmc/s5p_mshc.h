...
#define MSHCI_DBADDRH   0x8C    /* Descriptor list base address */
#define MSHCI_IDSTS     0x90    /* Internal DMAC status */
#define MSHCI_IDINTEN   0x94    /* Internal DMAC interrupt enable */
#define MSHCI_DSCADDR   0x98    /* Current host descriptor address */
#define MSHCI_DSCADDRH  0x9C    /* Current host descriptor address */
#define MSHCI_BUFADDR   0xA0    /* Current host buffer address */
#define MSHCI_BUFADDRH  0xA4    /* Current host buffer address */
...
#define MSHCI_AXI_BUSRT_LENGTH	0xB4	/* AXI burst length*/
#define MSHCI_SECTOR_NUM_INC	0x1F8
...
/*****************************************************
 *  MSHCI_MPSECURITY - offset 0x1010
 *****************************************************/
