...
#ifdef CONFIG_SKH_REV10

#define GPJ1CON		*(volatile unsigned int *)(0x14CE0000)
#define GPJ1DAT		*(volatile unsigned int *)(0x14CE0004)
#define GPJ1PUD		*(volatile unsigned int *)(0x14CE0008)

#define IIC0_ESCL_Hi		GPJ1DAT |= (0x1<<1)
#define IIC0_ESCL_Lo		GPJ1DAT &= ~(0x1<<1)
#define IIC0_ESDA_Hi		GPJ1DAT |= (0x1<<0)
#define IIC0_ESDA_Lo	GPJ1DAT &= ~(0x1<<0)

#define IIC0_ESCL_INP	GPJ1CON &= ~(0xf<<4)
#define IIC0_ESCL_OUTP	GPJ1CON = (GPJ1CON & ~(0xf<<4))|(0x1<<4)

#define IIC0_ESDA_INP	GPJ1CON &= ~(0xf<<0)
#define IIC0_ESDA_OUTP	GPJ1CON = (GPJ1CON & ~(0xf<<0))|(0x1<<0)

#define DELAY		100

#define GPIO_DAT	GPJ1DAT
#define GPIO_DAT_SHIFT	(0)
#define GPIO_PUD	GPJ1PUD &= ~(0xF<<0)
#else
