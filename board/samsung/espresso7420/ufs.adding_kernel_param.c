...
static int ufs_pre_setup(struct ufs_host *ufs)
{
	...
	if ( (readl(ufs->ioaddr + VS_FORCE_HCS)>>4)&0xf )
	{
		...
		writel(0x0, ufs->ioaddr + VS_FORCE_HCS);
#else
...
#if 0//defined(CONFIG_MACH_EXSOM7420SB)
static struct ufs_uic_cmd mphy_unipro_setup[] =
{
	{UIC_CMD_REGISTER_SET, 0x1b4, 0xE0, 0},		
	...
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x1564), 0, 0x10},
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x402), 0, 0x02},
	

	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x9540), 0, 0x01},	/* DBG_OV_TM */

	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x316, 0), 0, 0x316},	/* UFS_MPHY_RX_FILLER_ENABLE */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x317, 0), 0, 0x18},//uRx_linereset_pvalue},	/* Rx Linereset Pvalue */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x355, 0), 0, 0x10},//(uRx_Base_Unit)&0xff},	/* RX_BASE_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x354, 0), 0, 0x27},//(uRx_Base_Unit>>8)&0xff},		/* RX_BASE_NVALUE_15_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x353, 0), 0, 0x90},//(uRx_Gran_Unit)&0xff},		/* RX_GRAN_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x352, 0), 0, 0x01},//(uRx_Gran_Unit>>8)&0x03},	/* RX_GRAN_NVALUE_10_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x340, 0), 0, 0x02},//uRx_SleepCntTimer},	/* RX_OV_SLEEP_CNT_TIMER_6_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x341, 0), 0, 0x02},//uRx_StallCntTimer},	/* RX_OV_STALL_CND_TIMER_7_0 */

	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x316, 1), 0, 0x316},	/* UFS_MPHY_RX_FILLER_ENABLE */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x317, 1), 0, 0x18},//uRx_linereset_pvalue},	/* Rx Linereset Pvalue */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x355, 1), 0, 0x10},//(uRx_Base_Unit)&0xff},	/* RX_BASE_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x354, 1), 0, 0x27},//(uRx_Base_Unit>>8)&0xff},		/* RX_BASE_NVALUE_15_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x353, 1), 0, 0x90},//(uRx_Gran_Unit)&0xff},		/* RX_GRAN_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x352, 1), 0, 0x01},//(uRx_Gran_Unit>>8)&0x03},	/* RX_GRAN_NVALUE_10_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x340, 1), 0, 0x02},//uRx_SleepCntTimer},	/* RX_OV_SLEEP_CNT_TIMER_6_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x341, 1), 0, 0x02},//uRx_StallCntTimer},	/* RX_OV_STALL_CND_TIMER_7_0 */

	/* Lane0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x27d, 0), 0, 0x49},//uTx_linereset_pvalue},	/* Tx Linereset Pvalue */	
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x28d, 0), 0, 0xd0},//(uHigh_Z_Cnt)&0xFF},	/* TX_HIGH_Z_CNT_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x28c, 0), 0, 0x07},//(uHigh_Z_Cnt>>8)&0x0F},	/* TX_HIGH_Z_CNT_11_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x293, 0), 0, 0x10},//(uTx_Base_Unit)&0xFF},	/* TX_BASE_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x294, 0), 0, 0x27},//(uTx_Base_Unit>>8)&0xFF},	/* TX_BASE_NVALUE_15_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x295, 0), 0, 0x90},//(uTx_Gran_Unit)&0xFF},	/* TX_GRAN_NVALUE_7_0 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x296, 0), 0, 0x01},//(uTx_Gran_Unit>>8)&0x03},	/* TX_GRAN_NVALUE_10_8 */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x28e, 0), 0, 0x83},//(0x80|((uTx_Sleep_Cnt)&0x7F))},	/* TX_OV_SLEEP_CNT_TIMER_6_0 */
	...
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x8c, 0), 0, 0x0f},	/* RX_HS_G1PREPARE_LENGTH_CAPABILITY */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x96, 0), 0, 0x0f},	/* RX_HS_G2PREPARE_LENGTH_CAPABILITY */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x97, 0), 0, 0x0f},	/* RX_HS_G3PREPARE_LENGTH_CAPABILITY */
	...
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x8c, 1), 0, 0x0f},	/* RX_HS_G1PREPARE_LENGTH_CAPABILITY */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x96, 1), 0, 0x0f},	/* RX_HS_G2PREPARE_LENGTH_CAPABILITY */
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x97, 1), 0, 0x0f},	/* RX_HS_G3PREPARE_LENGTH_CAPABILITY */


	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x98, 0), 0, 0x07},
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x9A, 0), 0, 0x0A},

	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x98, 1), 0, 0x07},
	{UIC_CMD_DME_SET, UIC_ARG_MIB_SEL(0x9A, 1), 0, 0x0A},
...
{
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x402), 0, 0x00},
	...
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x4022), 0, 0x00},
	...
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x402), 0, 0x01},

	{UIC_CMD_REGISTER_SET, 0x10c, 0x32, 0},  
	{UIC_CMD_REGISTER_SET, 0x160, 0xA, 0},   
	{UIC_CMD_REGISTER_SET, 0x100, 0x8000000C, 0},   
	{UIC_CMD_REGISTER_SET, 0x104, 0xC, 0},

	{UIC_CMD_DME_SET, UIC_ARG_MIB(0xC001), 0, 0x01},
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x9529), 0, 0x01},	/* PA_DBG_MODE */
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x15aa), 0, 0x6},	
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x9529), 0, 0x00},	/* PA_DBG_MODE */
	
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x15a8), 0, 0x03},	
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x15a7), 0, 0x14},	
...
/* FAST Mode */
 ...
 /* Slow Mode */
	...
	{UIC_CMD_REGISTER_SET, 0x1094, 0xFFFF, 0},	/* rH_UNIPRO_DME_POWERMODE_REQ_LOCALL2TIMER0 */
	{UIC_CMD_REGISTER_SET, 0x1098, 0x1FFF, 0},	/* rH_UNIPRO_DME_POWERMODE_REQ_LOCALL2TIMER1 */
	{UIC_CMD_REGISTER_SET, 0x109c, 0x7FFF, 0},	/* rH_UNIPRO_DME_POWERMODE_REQ_LOCALL2TIMER2 */
...
static struct ufs_uic_cmd mphy_unipro_gear_change[] =
{
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x1568), 0, UFS_GEAR},	/* PA_TxGear */
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x1583), 0, UFS_GEAR},	/* PA_RxGear */
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x1560), 0, 1},//UFS_LANE},	/* PA_ActiveTxLane */
	{UIC_CMD_DME_SET, UIC_ARG_MIB(0x1580), 0, 1},//UFS_LANE},	/* PA_ActiveRxLane */
