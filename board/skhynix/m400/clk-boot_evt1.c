...
#endif
	if (kdiv == 0)
		bits0 = ((bits1 >> 8) & 0x3F) * 3000; /* Integer mode */
	else
...
//	bits0 = (4 << 28) | (0 << 20) | (0 << 12) | (3 << 8) | (3 << 4);	//400
...
//	bits0 = (0 << 28) | (0 << 24) | (0 << 20) | (0 << 16) | (1 << 12);  // 400
...
//	bits0 = (3 << 28) | (3 << 24) | (2 << 20) | (0 << 16) | (0 << 12);  // DVFS ver. < 2.5
...
//	bits0 = (0 << 28) | (0 << 24) | (1 << 20) | (3 << 16) | (3 << 12) | (0 << 8);  //	DVFS ver. < 2.5
...
//	bits0 = (3 << 28) | (1 << 24) | (1 << 20) | (2 << 16) | (2 << 12) | (2 << 8);    //	DVFS ver. < 2.5
...
int clk_init_big_cpu(void)
{
	...
	bits2 = (7 << 26) | (7 << 20) | (7 << 12) | (3 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	bits3 = (7 << 8) | (3 << 4) | (1 << 0); /* CLK_DIV_ATLAS1 */
	...
	bits2 = (7 << 26) | (7 << 20) | (7 << 12) | (2 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	bits3 = (7 << 8) | (3 << 4) | (1 << 0); /* CLK_DIV_ATLAS1 */
	...
	bits2 = (7 << 26) | (7 << 20) | (7 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	bits3 = (7 << 8) | (3 << 4) | (1 << 0); /* CLK_DIV_ATLAS1 */
	...
	bits2 = (6 << 26) | (6 << 20) | (6 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	...
	bits2 = (5 << 26) | (5 << 20) | (5 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	...
	bits2 = (4 << 26) | (4 << 20) | (4 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	bits3 = (4 << 8) | (3 << 4) | (1 << 0); /* CLK_DIV_ATLAS1 */
#elif (ATLAS_PLL_MHZ == 500)
	bits1 = (250 << 16) | (3 << 8) | (2 << 0);					/* ATLAS_PLL=500MHz */
	bits2 = (3 << 26) | (3 << 20) | (3 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_ATLAS0 */
	bits3 = (3 << 8) | (3 << 4) | (1 << 0); /* CLK_DIV_ATLAS1 */
...
int clk_init_little_cpu(void)
{
	...
	bits2 = (5 << 24) | (5 << 20) | (5 << 16) | (5 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_APOLLO0 */
	bits3 = (2 << 4) | (1 << 0); /* CLK_DIV_APOLLO1 */
	...
	bits2 = (4 << 24) | (4 << 20) | (4 << 16) | (4 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_APOLLO0 */
	bits3 = (2 << 4) | (1 << 0); /* CLK_DIV_APOLLO1 */
	...
	bits2 = (3 << 24) | (3 << 20) | (3 << 16) | (3 << 12) | (1 << 8) | (0 << 4) | (0 << 0); /* CLK_DIV_APOLLO0 */
	bits3 = (2 << 4) | (1 << 0); /* CLK_DIV_APOLLO1 */
...
int clk_init_mif(void)
{
	...
	*/
	...
	bits3 = asv_efuse;
	bits3 =(bits3 & 0xf);
	if ((bits3<=1) || (bits3==4) || (bits3>=9))
		bits1 = (316 << 16) | (3 << 8) | (0 << 0); /* MIF_PLL=2528MHz */ // MEMCLK = 1264 MHz
	else if ((bits3==2) || (bits3==3) || (bits3==6) || (bits3==7)
		|| (bits3==8))
	...
	*/
	...
	bits0 = (1 << 4) | (1 << 0);
#ifdef __KERNEL__
	if ((bits3==2) || (bits3==3) || (bits3==6) || (bits3==7)
		|| (bits3==8))	// MEM_CLK 1552MHz
		bits0 = (2 << 4) | (1 << 0);
#endif
